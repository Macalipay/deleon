                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Consumable Product Maintenance Screen
                                            ...
                                            @foreach ($consumables as $key => $consumable)
                                                <tr>
                                                    ...
                                                    <td class="table-action">
                                                        ...
                                                        <a href="{{url('consumable/destroy/' . $consumable->id)}}" onclick="alert('Are you sure you want to Delete?')"><i class="align-middle fas fa-fw fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        ...
                        <div class="form-group col-md-12">
                            <label for="inputPassword4">Consumable Name</label>
                            <input type="text" class="form-control" id="consumable" name="consumable" placeholder="Enter Consumable">
                        </div>
                    </div>
        ...
        function edit(id){
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#modal-form').attr('action', 'consumable/update/' + data.consumables.id);
                }
            });

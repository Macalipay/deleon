                                            ...
                                            @foreach ($payments as $key => $payment)
                                                <tr>
                                                    ...
                                                    <td class="table-action">
                                                        ...
                                                        <a href="{{url('payment_type/destroy/' . $payment->id)}}" onclick="alert('Are you sure you want to Delete?')"><i class="align-middle fas fa-fw fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        <form id="modal-form" action="{{url('payment_type/save')}}" method="post">
                            @csrf
                        <div class="form-group col-md-12">
                            <label for="inputPassword4">Payment Name</label>
    ...
    <script>
        function edit(id){
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#modal-form').attr('action', 'payment_type/update/' + data.payments.id);
                }
            });
        ...
        $(function() {
            ...
            $('.add').click(function(){
                ...
                $('#modal-form').attr('action', 'payment_type/save');

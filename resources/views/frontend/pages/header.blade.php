<section class="section section-xs bg-gradient-1 oh text-center text-xl-left">
    <div class="container">
        ...
        <div class="col-xl-6 col-xxl-5">
          ...
          <div class="box-promo">
            ...
            <div class="heading-1 text-uppercase font-weight-bold wow fadeIn" data-wow-delay="1.7s">
              <div class="big text-bordered-1">JOIN US</div>
            </div>
            <div class="decor-element decor-element-2 wow fadeIn" data-wow-delay=".6s">
              <svg class="animation-rotate-1" width="176" height="198" viewBox="0 0 176 198" fill="none">
                <path opacity="0.15" d="M85.5 10.9904C87.047 10.0972 88.953 10.0972 90.5 10.9904L162.969 52.8301C164.516 53.7233 165.469 55.3739 165.469 57.1603V140.84C165.469 142.626 164.516 144.277 162.969 145.17L90.5 187.01C88.953 187.903 87.047 187.903 85.5 187.01L13.0314 145.17L8.03143 153.83L13.0314 145.17C11.4844 144.277 10.5314 142.626 10.5314 140.84V57.1603C10.5314 55.3739 11.4844 53.7233 13.0314 52.8301L85.5 10.9904Z" stroke="#fff" stroke-width="20"></path>
              </svg>
            </div>
          </div>
        </div>
